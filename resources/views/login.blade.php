...
<div class="d-flex flex-column flex-root">
  ...
  <div class="login-aside flex-row-fluid d-flex flex-column"
             style="background-image:url({{url('assets/media/bg/bg-login.jpg')}});background-repeat: no-repeat;background-repeat: round;">
                ...
                <div class="login-form">
                    ...
                    <!--begin::Title-->
                        <div class="pb-5 pb-lg-5 mb-4">
                            ...
                            <img src="{{ asset('assets/media/logos/logo-stetoshop.png') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" id="show_hide_password">
                                <input class="form-control form-control-solid py-7 px-6 border-0"
                                   type="password"
                                   name="password" autocomplete="off" value="" style="border-radius: 0.85rem 0rem 0rem 0.85rem;"/>
                                   <div class="input-group-addon py-4 px-6 border-0" style="background-color: #dddddd; border-radius: 0rem 0.85rem 0.85rem 0rem;">
                                    <a href=""><i class="fa fa-eye-slash" aria-hidden="true" style="color: #0496FF"></i></a>
                                  </div>
                            </div>
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" style="background-color:#0496FF;"

        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalMenuTitle">Create Menus</h5>
                ...
                <form role="form" class="form" name="formmenus" id="formmenus" enctype="multipart/formdata" method="">
                    <div class="modal-body" style="height: 500px;">
                        <div class="mb-7">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="name" placeholder="e.g: Dashboard"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="icon" placeholder="e.g: fa fa-list"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control select2" name="parent_id" style="width: 100%;">
                                        <option class="form-control" value='0'> Is Parent </option>
                                        @foreach($menu as $mn)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="type" placeholder="e.g: dashboard"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="permission" placeholder="e.g: dashboard"/>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal"><i class="fa fa-times"></i>Cancel</button>
                        @can(['menusetting-C' , 'menusetting-U'])
        ...
        $(document).ready(function () {
                ...
                datatable.KTDatatable({
                    ...
                    columns: [{
                            ...
                            template: function (row) {
                                return `<span><i class="${row.icon}"></i></span>`;
                            }
                        },{
                            field: 'parent_id',
                            title: 'Parent',
            ...
            @can('menusetting-C')
                $(document).on('click','#addMenu', function(){
                    $("#saveMenu").data("id", "");
                    $('#modalMenuTitle').text('Create Data Menu');
            ...
            @can('menusetting-U')
                $(document).on('click','.edits', function(){
                    $.ajax({
                        ...
                        url: './menusetting/'+$(this).data('id'), // the url where we want to POST
                        beforeSend : function(){
                            let form = document.forms.formmenus; // <form name="formmenus"> element
                            form.reset();
                        }
            ...
            @can(['menusetting-C', 'menusetting-U'])
                $('#formmenus').submit(function(e){
                    ...
                    var url = (menuID != "") ? `./menusetting/${menuID}` : `./menusetting`;

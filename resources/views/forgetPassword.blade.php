...
<div class="d-flex flex-column flex-root card">
                ...
                <div class="login-form">
                    ...
                    @csrf
                        <div class="pb-5 pb-lg-5">
                            <img src="{{ asset('assets/media/logos/login-icon.png') }}" style=" display: block;margin: 0 auto; width: 240px;" alt=""/>
                        </div>
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" style="background-color:#0496FF;" id="kt_login_singin_form_submit_button" class="btn btn-primary btn-lg btn-block font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">
                                Reset Password
                            </button>
                            <a href="/" class="btn btn-secondary btn-lg btn-block font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">   
                                Kembali
                            </a>
                        </div>
                        </form>
